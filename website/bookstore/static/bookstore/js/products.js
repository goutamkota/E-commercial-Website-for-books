const getProducts = async () => {
  try {
    const results = await fetch("/static/bookstore/js/products.json");
    ...
    product => ` 
                  <div class="product category__products">
                    <div class="product__header">
                      <img src="./static/bookstore/Images/${product.image}" alt="product">
                    </div>
                    <div class="product__footer">
                      ...
                      <div class="rating">
                        <svg>
                          <use xlink:href="./static/bookstore/Images/sprite.svg#icon-star-full"></use>
                        </svg>
                        <svg>
                          <use xlink:href="./static/bookstore/Images/sprite.svg#icon-star-full"></use>
                        </svg>
                        ...
                        <svg>
                          <use xlink:href="./static/bookstore/Images/sprite.svg#icon-star-empty"></use>
                        </svg>
                      </div>
                  ...
                  <ul class="layer">
                      <li>
                        <a data-tip="Quick View" data-place="left" href="#">
                          <svg>
                            <use xlink:href="./static/bookstore/Images/sprite.svg#icon-eye"></use>
                          </svg>
                        </a>
                      </li>
                      <li>
                        <a data-tip="Add To Wishlist" data-place="left" href="#">
                          <svg>
                            <use xlink:href="./static/bookstore/Images/sprite.svg#icon-heart-o"></use>
                          </svg>
                        </a>
                      </li>
                  </ul>
...
["mouseover", "touchstart"].forEach(event => {
  if (picContainer) {
    picContainer.addEventListener(event, e => {
      ...
      changeImage(`./static/bookstore/Images/products/iPhone/iphone${id}.jpeg`, id);
    });
  }
});
